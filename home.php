    ...
    ?>
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card product-card h-100 shadow-sm border-0">
                <div id="carousel<?php echo $product_data["product_id"]; ?>" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <?php
                        $first = true;
                        ...
                        ?>
                            <div class="carousel-item <?php echo $first ? 'active' : ''; ?>">
                                <img src="<?php echo $img_data["path"]; ?>" class="d-block w-100" alt="<?php echo $product_data["title"]; ?>" style="height: 200px; object-fit: cover;">
                            </div>
                        <?php
                            $first = false;
                        }
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <span class="h5 mb-0">Rs.<?php echo number_format($product_data["price"], 2); ?></span>
